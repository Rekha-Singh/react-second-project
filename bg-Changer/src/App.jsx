...
function App() {
  ...
  return (
    ...
    <div className="fixed flex flex-wrap justify-center top-12 inset-x-0 px-2">
      <div className="flex flex-wrap gap-3 justify-center shadow-lg bg-black px-3 py-2 rounded-3xl">
        ...
        <button onClick={ ()=>setColor(" navy")} className="outline-none px-4 py-1 rounded-full text-white shadow-lg " style={{backgroundColor:"navy"}} >Navyblue</button>
